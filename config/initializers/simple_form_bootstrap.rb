...
SimpleForm.setup do |config|
  ...
  # without_label
  config.wrappers :without_label, tag: 'div', class: 'form-group col-md-12', error_class: 'has-error', valid_class: 'has-success' do |b|
    b.use :html5
    b.use :placeholder
  ...
  config.wrappers :vertical_boolean, class: 'icheck-primary', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'form-group row', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    ...
    b.optional :min_max
    b.optional :readonly
    b.use :label, class: 'col-sm-2 col-form-label control-label'
  ...
  config.wrappers :horizontal_collection, item_wrapper_class: 'form-check', tag: 'div', class: 'form-group row', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'col-sm-2 form-control-label control-label'
    b.wrapper :grid_wrapper, tag: 'div', class: 'col-sm-10' do |ba|
  ...
  config.wrappers :vertical_form_without_icon, tag: 'div', class: 'form-group', error_class: 'has-error', valid_class: 'has-success' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
